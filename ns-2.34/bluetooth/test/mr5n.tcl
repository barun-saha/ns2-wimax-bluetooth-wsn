...
$ns attach-agent $node(2) $null0

$ns connect $udp0 $null0

set udp1 [new Agent/UDP]
$ns attach-agent $node(3) $udp1
...
$ns at 0.01 "$node(1) make-pico-fast DH5 DH5 0"
$ns at 0.1 "$node(2) make-pico-fast DH5 DH5 0"
$ns at 0.2 "$node(3) make-pico-fast DH5 DH5 0"
$ns at 0.3 "$node(4) make-pico-fast DH5 DH5 0"
#$ns at 0.4 "$node(5) make-pico-fast DH5 DH5 0"
