/* -*- c++ -*-
   packet-stamp.h
   $Id: packet-stamp.h,v 1.1.1.1 2008/04/11 18:40:30 rouil Exp $
...
//  double **RxIntPr;               // pointer to the interference level at which the packet is received.// chk ** with *[]
//  double *RxPr_OFDMA;                 // power with which pkt is received 
   // double RxIntPr [100][1024]; ////removed for testing without Rxinpwr in packet header// remove now 18th oct
    double RxPr_OFDMA [1024];   //removed for testing without Rxinpwr in packet header
