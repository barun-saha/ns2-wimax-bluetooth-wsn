...
{	
 ...
 public:
   ...
   * @return the CID for this burst
   */
  inline u_char getB_CDMA_CODE( ) { return b_cdma_code_; }
  inline u_char getB_CDMA_TOP( ) { return b_cdma_top_; }
  inline void setB_CDMA_CODE( u_char cdma_code ) { b_cdma_code_ = cdma_code; }
  inline void setB_CDMA_TOP( u_char cdma_top ) { b_cdma_top_ = cdma_top; }
